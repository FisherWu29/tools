(function(exports){
    var KeyBoard = function(input, options){
        ...
        var height = options && options.height || '185px';
        ...
        btnStr += 'line-height:28px;border-radius:3px;margin-bottom:5px;cursor:pointer;display:none;">完成</div>';
        ...
        function addEvent(e){
            ...
            var password_len = document.getElementById("bizCustomerPwd").value.length;
            if(clickEl.tagName.toLocaleLowerCase() === 'td' && value !== "删除"){
                if(self.input && password_len <= 6){
            ...
            var pwdlen = document.getElementById("bizCustomerPwd").value.length;
            if( pwdlen == 6 ){
                comitCustomerPay();
            }
        }
