var lazyLoad = {
    init: function() {
        var that = this;
        that.onerrorImgUrl = "/assets/img/default/default@251.jpg";
        that.srcStore = "data-src";
        that.class = "ui-radius-6";
        that.sensitivity = 50;
        minScroll = 5,
            slowScrollTime = 200,
    ...
    changeimg: function() {
        function loadYesOrno(img) {
            ...
            var flag = imgOffsetTop >= windowPageYOffset && imgOffsetTop - that.sensitivity <= windowPageYOffsetAddHeight;
            return flag;
        }
